...
public class QEvent extends EntityPathBase<Event> {
    ...
    private static final long serialVersionUID = 319922486L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEvent event = new QEvent("event");

    public final org.salespointframework.quantity.QQuantity capacity;
    ...
    public QEvent(Class<? extends Event> type, PathMetadata metadata, PathInits inits) {
        ...
        this.capacity = inits.isInitialized("capacity") ? new org.salespointframework.quantity.QQuantity(forProperty("capacity")) : null;
    }
